...
namespace TCP_chat.Server
{
    public class ServerObject
    {
        ...
        TcpListener tcpListener = new TcpListener(System.Net.IPAddress.Any, 8888); // сервер для прослушивания
        ...
        protected internal async Task SendFileToClientAsync(ClientObject client, string fileName, string userName)
        {
            ...
            Task value = client.GetStream().WriteAsync(header).AsTask();
            Task value1 = client.GetStream().FlushAsync();
            ...
            await Task.WhenAll(value, value1); 
